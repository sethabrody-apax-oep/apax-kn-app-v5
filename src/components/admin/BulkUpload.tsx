...
export default function BulkUpload({ onUpload, onCancel }: BulkUploadProps) {
  ...
  const handleFile = async (file: File) => {
    ...
    try {
      ...
      const requiredHeaders = ['firstname', 'lastname', 'email', 'title', 'company']
      ...
      for (let i = 1; i < lines.length; i++) {
        ...
        // Validate required fields (email is no longer required for spouses)
        ...
        if (row.id && row.id.trim()) {
          ...
          delete row.id // Remove empty id field
        }
        
        // Set defaults for optional fields
        row.bio = row.bio || ''
        row.phone = row.phone || ''
        row.photo = row.photo || '/Apax_Favicon_32x32-1 copy.png'
        ...
        if (row.hasSpouse && row.spousefirstname && row.spouselastname) {
          row.spouseDetails = {
            ...
            email: row.spouseemail || '', // Allow empty spouse email
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-brand-gray">
            Upload multiple attendees using a CSV file
          </p>
        </div>
        <button
          onClick={onCancel}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <ul className="text-sm text-brand-gray space-y-1">
              ...
              <li>• <strong>hotelselection</strong> - Hotel selection (grand-hotel, business-center, luxury-suites, custom)</li>
              <li>• <strong>apaxip</strong> - Apax IP (1 or 0)</li>
              <li>• <strong>apaxoep</strong> - Apax OEP (1 or 0)</li>
              <li>• <strong>portfoliocompanyexecutive</strong> - Portfolio Company Executive (1 or 0)</li>
              <li>• <strong>sponsorattendee</strong> - Sponsor Attendee (1 or 0)</li>
              <li>• <strong>speaker</strong> - Speaker (1 or 0)</li>
              <li>• <strong>spouse</strong> - Spouse (1 or 0)</li>
              <li>• <strong>ceo</strong> - CEO (1 or 0)</li>
              <li>• <strong>clevelexec</strong> - C-level Exec (1 or 0)</li>
              <li>• <strong>otherattendeettype</strong> - Other Attendee Type (1 or 0)</li>
        ...
        {uploadedData.length > 0 && (
          <div className="bg-white rounded-xl shadow-sm border border-green-200 p-6">
            ...
            <div className="flex justify-end space-x-4">
              ...
              >
                Upload {uploadedData.length} Attendees
              </button>
            </div>
          </div>
        )}
